...
def dragon1():
    while True:
        ...
        if id == horse_id:
            ...
            print ("Choose your money pouch to compensate the driver for the horse. Choose your horse to continue on your way without paying the driver.")
            ...
            if id == pouch_id:
                ...
                town_menu()
            if id == horse_id:
                print("First one or two and then a huge group of travelrs are pointing at you and shouting on behalf of the merchant whose horse became the dragon's lunch.")
...
def forest_thieves():
    while True:
        ...
        if id == shield_id:
            ...
            print("~")
            print("Scan your sword to remember that a very large reward is givin if you find Robin Hood, take the meat, and rat out Robin Hood")
            ...
            if id == sword_id:
                ...
                print("Robin Hood is caught, little Jon finds you and eliminates you, maybe you should of kept Robin Hood's secret")
            ...
            if id == pouch_id:
                print("As you are walking away, Robin Hood yells, he asks if you would like to join his crew and help him on his adventure")
                print("~")
...
def dragon_2():
    while True:
        ...
        print("~")
        sleep(2)
        print("The forest grows darker and more crowded, so crowded Stanley can't even spreaf her wings to fly.")
        print("The only way through is straight ahead.")
        print("~")
        sleep(2)
        print("You and the dragon are tired. So you are tremendously relieved to see a wide cave up ahead.")
        ...
        if id == horse_id:
            ...
            if id == spell_id:
                ...
                if id == sword_id:
                    ...
                    print("~")
                    sleep(2)
                    print("You hear a dreadful moan and thud. The dragon dies.")
                    print("~")
                    sleep(2)
                    ...
                    print("~")
                    sleep(2)
                    print("Choose the dragon to rush up and pay your final respects to Stanley. Choose the horse to continue on.")
                    ...
                    if id == dragon_id:
                        ...
                        menu()
                    if id == horse_id:
                        print("You leap upon Stanley and the two of you charge off down the hill.")
...
def market():
    while True:
        ...
        print("So many sights and smells tickle your senses that you don't notice a group of masked jugglers start to fall in step behind and around you.")
        print("~")
        sleep(2)
        print("A pair of hands pulls a hood over your head. Your own hands are bound behind you.")
        print("You are dragged away from the market and through the maze of zig-zagging cobbled paths that form the streets of this town.")
        ...
        print("You can feel the binds around your wrists loosen as your captors release you to the floor.")
        ...
        if id == heart_id:
            ...
            print("~")
            print("Choose your money pouch to accept the minstrels' gifts and continue on your journey. Or choose the horse to join the minstrels.")
...
def magic_shop():
    while True:
        ...
        if id == dragon_id:
            print("The shop seems to grow colder as you move towards the the back of the shop.")
            ...
            if id == pouch_id:
                print("As you make your way toward the front of the shop you knock into a table of small glass bottles filled with shimmering colors. You catch one bottle as its about fall to the floor, the shopkeeper is startled awake and looks you over with an overtly disaproving gaze.")
                print("~")
                sleep(2)
                print("What do you want?")
                sleep(2)
                ...
                if id == pouch_id:
                    ...
                    if id == potion_id:
                        print("You look down at the glowing potion and decide to take a chance.")
                        rint("The potion is slowly glowing red, then blue, then green.")
                        print("~")
                        print("To drink the potion while it's glowing red choose the heart, for green choose the dragon, or for blue choose the shield.")
                        print("~")
                        sleep(2)
...
def river_road():
    while True:
        ...
        sleep(2)
        print("As you make your way through the valley, you are careful to stick as close to the river as possible, for you hear distant, chilling howls, and you fear what might lurk in the shadows.")
        print("The river's current is a comforting rumble beside you.")
        print("~")
        print("...")
        print("Before long, the river drops suddenly into a waterfall.")
        print("You look down and are astonished to spy a ship with black sails nestled in a bay close to the falls. You can  see and smell the ocean beyond.")
        sleep(3)
        ...
        if id == shield_id:
            ...
            ##This is where the pirate ship stuff will go
                ...
                if id == shield_id:
                    ...
                    if id == spell_id:
                        ...
                        if id == frost_id:
                            ...
                            print("~")
                            print("You live out your days helping the villagers rebuild their town and fields from the damage done by the bewitched queen.")
                            sleep(3)
            ...
            if id == sword_id:
                ...
                if id == sword_id:
                    ...
                    if id == horse_id:
                        ...
                        print("Then he wandered off, leaving you to dust yourself off, soothe your horse, and wander around looking for entertainment.")
                        print("~")
                        sleep(2)
                        tournament()
